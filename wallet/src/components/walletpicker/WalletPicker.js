      ...
      <div className={styles.WalletPicker}>
        ...
        <div className={styles.directive}>
          ...
          <div className={styles.Title}>
            ...
            <span className={styles.B}>MetaMask L2 Setup.</span>{' '}Click{' '}<span className={`${styles.B} ${styles.link}`} onClick={()=>networkService.addL2Network()}>here</span> to add L2 network. If you want to add it by yourself, {' '}please go to <span className={styles.B}>MetaMask&#62;Settings&#62;Networks&#62;Add Network</span>.{' '}Specify `http://rinkeby.omgx.network` as the New RPC URL.<br/><br/>
            <br/>
            <br/>
          </div>
